  ...
  fastify.put("/api/screens/:id", {
    ...
    fastify.wsNotifier.notifyAllScreens({
      ...
      templateText: {
        ...
        kpi1Label: s.templateKpi1Label,
        kpi1Value: s.templateKpi1Value,
        kpi2Label: s.templateKpi2Label,
        kpi2Value: s.templateKpi2Value,
        kpi3Label: s.templateKpi3Label,
        kpi3Value: s.templateKpi3Value,
      },
      templateStyle: {
        ...
        showKpis: s.templateShowKpis || null,
